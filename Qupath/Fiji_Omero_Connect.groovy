...
#@ String(label="Username", value="Your Username") USERNAME
#@ String(label="Password", style='password', value="") PASSWORD
#@ String(label="Host", value='Your Host Name') HOST
#@ Integer(label="Dataset ID", value=0) DATASETID
